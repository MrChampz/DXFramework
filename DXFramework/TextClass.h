...
public:
	...
	bool Initialize(ID3D11Device*, ID3D11DeviceContext*, int, int, int, bool, FontClass*,
...
private:
	...
	void RenderSentence(ID3D11DeviceContext*, ShaderManagerClass*, XMMATRIX, XMMATRIX, XMMATRIX,
