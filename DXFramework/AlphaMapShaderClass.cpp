...
bool AlphaMapShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"Shaders/AlphaMap.vs", L"Shaders/AlphaMap.ps");
	if (!result)
	{
		return false;
	}
...
bool AlphaMapShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DCompileFromFile(vsFilename, NULL, NULL, "AlphaMapVertexShader", "vs_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
	...
	result = D3DCompileFromFile(psFilename, NULL, NULL, "AlphaMapPixelShader", "ps_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
