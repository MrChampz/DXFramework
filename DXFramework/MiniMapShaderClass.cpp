/////////////////////////////////////////////
//	Filename: MiniMapShaderClass.cpp
/////////////////////////////////////////////
#include "MiniMapShaderClass.h"

MiniMapShaderClass::MiniMapShaderClass()
{
	m_vertexShader = 0;
	m_pixelShader = 0;
	m_layout = 0;
...
MiniMapShaderClass::MiniMapShaderClass(const MiniMapShaderClass& other)
{
}
...
bool MiniMapShaderClass::Initialize(ID3D10Device* device, HWND hwnd)
{
	bool result;

	// Initialize the vertex and pixel shaders
	result = InitializeShader(device, hwnd, L"Shaders/MiniMap.vs", L"Shaders/MiniMap.ps");
	if (!result)
	{
		return false;
	}
...
void MiniMapShaderClass::Shutdown()
{
...
bool MiniMapShaderClass::Render(ID3D10Device* device, int indexCount,
...
bool MiniMapShaderClass::InitializeShader(ID3D10Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
	...
	result = D3DCompileFromFile(vsFilename, NULL, NULL, "MiniMapVertexShader", "vs_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
	...
	result = D3DCompileFromFile(psFilename, NULL, NULL, "MiniMapPixelShader", "ps_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
...
void MiniMapShaderClass::ShutdownShader()
{
...
void MiniMapShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	char* compileErrors;
...
bool MiniMapShaderClass::SetShaderParameters(ID3D10Device* device,
	XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, ID3D10ShaderResourceView* texture)
{
	HRESULT result;
	void* mappedResource;
...
void MiniMapShaderClass::RenderShader(ID3D10Device* device, int indexCount)
{
