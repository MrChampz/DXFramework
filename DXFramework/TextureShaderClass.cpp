...
bool TextureShaderClass::Render(ID3D10Device* device, int indexCount,
...
bool TextureShaderClass::InitializeShader(ID3D10Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
bool TextureShaderClass::SetShaderParameters(ID3D10Device* device,
	XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, ID3D10ShaderResourceView* texture)
{
	HRESULT result;
	void* mappedResource;
